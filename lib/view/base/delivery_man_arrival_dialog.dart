...
class DeliveryManArrivalDialog extends StatefulWidget {
  final String icon;
  final String title;
  ...
  @override
  State<DeliveryManArrivalDialog> createState() => _DeliveryManArrivalDialogState();
}

class _DeliveryManArrivalDialogState extends State<DeliveryManArrivalDialog> {
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Container(
                  ...
                  child: CustomTextField(
                    ...
                    hintText: 'Enter Arrival Time in Minutes',
                    isEnabled: true,
